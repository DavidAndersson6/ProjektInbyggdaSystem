...
unsigned int timeInput;


bool start = true;


#define SSID "Wajfaj"     // "SSID-WiFiname" 
#define PASS "Telefon987654321"       // "password"
#define IP "184.106.153.149"// thingspeak.com ip
String msg = "GET /update?key=K9JXVKWZPA27ZI0R"; //change it with your api key like "GET /update?key=Your Api Key"
...
void loop() {
  ...
  runUntil(updateBeat, timeInput);
  runAfter(servoLoop, timeInput);
updateBeat();
start: //label
  error = 0;
...
void runAfter(void func(), int t)
{
  ...
  if (currentMillis - startMillis > (t * 1000))
  {
